...
* Speaker: __Matt Gardner__ ([EmberCamp](https://github.com/allthesignals))
...
* Speakers:
  * __[Jen Weber](https://twitter.com/jwwwweber)__ ([GitHiub](https://github.com/jenweber))
